...
- **Speaking rate:** 1.0 (natural)
- **Output size:** ~400-450KB per episode
- **Name in admin:** "Google TTS (Standard Quality)" ← *This is actually the default good choice*
...
- **Name in admin:** "Google Wavenet Premium (Highest Quality)" ← *Choose this for BEST sounding*
