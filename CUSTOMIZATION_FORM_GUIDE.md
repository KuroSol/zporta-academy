# 📝 Customization Form Guide - Complete Walkthrough

## Overview

When you select courses/lessons/quizzes and click the **"✏️ Generate Script Text"** button, a **Customization Form** appears where you can specify exactly what kind of podcast script you want.
...
│ ║ ☐ Tenses Advanced (English Mastery)             ║ │
│ ║ ☐ Conversational French (French Basics)         ║ │
│ ║                                                 ║ │
│ ║ Quizzes (2):                                    ║ │
│ ║ ☐ Verb Tenses Quiz (English Mastery)            ║ │
│ ║ ☐ Business Idioms Quiz (Business Comm)          ║ │
│ ╚═════════════════════════════════════════════════╝ │
│                                                     │
...
│                                                     │
│ ✓ Selected Items (3)                               │
│ [📚 English Mastery ✕] [📖 Grammar Basics ✕]      │
│ [✓ Verb Tenses Quiz ✕]                            │
│ (white background, blue border, black text)        │
│                                                     │
...
│ │ (Click this button to customize & generate)     ││
│ └─────────────────────────────────────────────────┘│
│                                                     │
└─────────────────────────────────────────────────────┘
```

### Step 3: The Customization Form Opens

When you click the "Generate Script Text" button, this form appears:
...
║ │ [e.g., Business English, Hair Styling ...]  │  ║
║ │ ┌──────────────────────────────────────────┐│  ║
║ │ │Business English                          ││  ║
║ │ └──────────────────────────────────────────┘│  ║
║ └──────────────────────────────────────────────┘  ║
...
║ │ [e.g., Negotiation, Customer Service...]   │  ║
║ │ ┌──────────────────────────────────────────┐│  ║
...
║                                                     ║
║ ┌──────────────────────────────────────────────┐  ║
║ │ 👤 Your Profession / Context (OPTIONAL)     │  ║
║ │ [e.g., Hair stylist in Germany...]         │  ║
║ │ ┌──────────────────────────────────────────┐│  ║
...
║                                                     ║
║ ┌──────────────────────────────────────────────┐  ║
║ │ 🗣️ Preferred Language (PRIMARY) (REQUIRED) │  ║
║ │ ┌──────────────────────────────────────────┐│  ║
║ │ │ English          ▼                        ││  ║
║ │ │ Spanish                                   ││  ║
║ │ │ French                                    ││  ║
...
║ │ ┌──────────────────────────────────────────┐│  ║
║ │ │Keep it casual, include real-world        ││  ║
║ │ │examples, 10 minutes long                 ││  ║
║ │ │                                          ││  ║
║ │ └──────────────────────────────────────────┘│  ║
║ └──────────────────────────────────────────────┘  ║
║                                                     ║
...
**Why it matters:** Tells the AI what domain/subject area to focus on
...
**Why it matters:** Helps the AI narrow down and focus the content even more
...
- "Student learning English as second language"
- "Restaurant owner in France"

**Why it matters:** The AI will tailor examples and context to be relevant to YOUR situation
...
**Why it matters:** The entire script will be generated in this language
...
**Why it matters:** Helps with language learning by comparing two languages side-by-side
...
- "Make it beginner-friendly with simple words"
- "Add quiz questions at the end"
- "10 minutes long for morning commute"
- "Include industry-specific terminology"

**Why it matters:** Tells the AI HOW to write the script (tone, length, style, etc.)

---

## Complete Example: From Selection to Generation
...
👤 Profession: Sales manager at tech startup in Silicon Valley
🗣️ Primary Language: English
🌐 Secondary Language: Spanish (to learn business phrases in both languages)
📝 Notes: Keep it practical with real email examples, 8-10 minutes, casual tone
```
...
[1] THE ANATOMY OF A BUSINESS EMAIL
...
- "Touch base" = Check in / Stay in contact
- "Ball is in their court" = Waiting for their decision
- "On the same page" = Everyone agrees
- "Bottom line" = The most important thing
- "Cut to the chase" = Get to the point

[3] PRACTICAL EXAMPLES FOR SALES
When following up:
"I wanted to touch base about the proposal we discussed."

When negotiating:
"We need to make sure we're on the same page about pricing."
...
4. ✅ Click **"Regenerate Audio"** to convert it to audio
5. ✅ Or click **"Generate Script Text"** again to create a different version
...
- You can ask for quiz questions, examples, or specific length
...
1. **Form filled out** → Click "Generate Script Text"
2. **AI receives all your preferences**:
   - ✅ Which courses/lessons/quizzes you selected
   - ✅ What category/subject
   - ✅ What topic (if specified)
   - ✅ Your profession/context
   - ✅ Primary language
   - ✅ Secondary language (if any)
   - ✅ Any style notes
3. **LLM generates a customized script** that:
   - Covers all selected content
   - Tailored to your category
   - Includes examples relevant to your profession
   - In your preferred language(s)
   - With the style/format you requested
4. **Script appears in the Script Text field**
5. **You can save or regenerate as needed**
