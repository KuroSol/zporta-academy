// CreateLesson.js
// Version with improved template handling and restored subject logic.

import React, { useState, useEffect, useRef, useContext, useCallback } from 'react';
import { useNavigate } from 'react-router-dom';
import CustomEditor from '../Editor/CustomEditor'; // Assuming path is correct
import apiClient from '../../api'; // Assuming path is correct
...
const CreateLesson = ({ onSuccess, onClose, isModalMode = false, initialSubjectId = null }) => {
    ...
    }, [logout, initialSubjectId, isModalMode, navigate]);
    ...
    }, [fetchData, isModalMode, navigate]);
    ...
    const handleSaveLesson = async () => {
        ...
        try {
            ...
            if (isModalMode && onSuccess) {
                ...
                setTimeout(() => navigate('/admin/lessons'), overallMessageType === 'success' ? 2000 : 4000);
            }
        } catch (error) {
