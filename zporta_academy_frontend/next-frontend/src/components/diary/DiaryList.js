...
const DiaryList = () => {
  ...
  return (
    <div className={styles["diary-list-container"]}>
      <h2 className={styles["diary-list-title"]}>Your Diary Entries</h2>
      ...
      {filtered.length === 0 ? (
        ...
        <>
          <div className={styles["table-responsive"]}>
            <table className={styles["diary-table"]}>
              <thead>
                <tr>
                  <th>#</th>
                  <th>Text</th>
                ...
                {currentNotes.map((n, i) => {
                  ...
                  return (
                    <tr key={n.id}>
                      ...
                      <td>
                        <div
                          className="note-text" /* stays global; styled via module using :global under .diary-table */
                          dangerouslySetInnerHTML={{ __html: display }}
                        />
                        {!searchTerm && getPlainText(n.text).split(/\s+/).length > 4 && (
                          <button className={styles["see-more-btn"]} onClick={() => openModal(n)}>
                      ...
                      <td>
                        <div className={styles["diary-action-buttons"]}>
          ...
          <div className={styles.pagination}>
            ...
            {[...Array(total)].map((_, i) => (
              <button
                ...
                className={currentPage === i+1 ? styles.active : undefined}
              >{i+1}</button>
            ))}
            <button
