...
import styles from '@/styles/Editor/CustomEditor.module.css';
...
// END OF BLOCK TO ADD
    ...
    return (
        ...
        <div className={`${styles.editorContainer} ${isFullscreen ? styles.fullscreen : ''}`} onBlur={handleBlur}>
...
{/* --- Previous Element Actions --- */}
              {selectedElement && (selectedElement.classList.contains('image-wrapper') || selectedElement.classList.contains('audio-wrapper')) && (
                 <span className={`${styles.editorElementActions} editor-element-actions`} style={{ marginLeft: '10px', borderLeft: '1px solid #ccc', paddingLeft: '10px' }}>
            ...
            {enablePrivacyToggle && (
                ...
                */}
             {/* Upload Errors */}
            {uploadError && <p className={`${styles.editorUploadError} editor-upload-error`}>{uploadError}</p>}
            ...
            {viewSource ? (
                <textarea
                    ...
                    className={`${styles.editor} ${styles.sourceView}`}
                ...
                <div
                    ...
                    className={`${styles.editor} ${styles.wysiwygView} ${!editable ? styles.isReadonly : ''}`}
                    placeholder={placeholder}
