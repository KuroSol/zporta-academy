  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Something went wrong on our end. Our team has been notified and is working on it." />
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: '72px', margin: '0 0 20px 0', color: '#333' }}>500</h1>
        <h2 style={{ fontSize: '28px', margin: '0 0 30px 0', color: '#666' }}>Server Error</h2>
        ...
        <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', justifyContent: 'center' }}>
          ...
          <a href="mailto:support@zportaacademy.com" style={{
            padding: '12px 24px',
