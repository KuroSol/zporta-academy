...
export default function Page() {
	...
	const description = 'Access comprehensive online courses, interactive lessons, and engaging quizzes. Track your progress with AI-powered study plans on Zporta Academy.';
	const keywords = 'online learning, courses, lessons, quizzes, education, study plan, AI dashboard, Zporta Academy';
	return (
		<>
			<Head>
				<title>{title}</title>
				...
				<meta property="og:image:alt" content="Zporta Academy - Online Learning Platform" />
